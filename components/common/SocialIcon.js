...
// Source for svgs: https://www.iconfinder.com/iconsets/social-media-2285
function SocialIcon({ name }) {
    ...
    // Return an empty red box if icon is not defined
    return (
        <button className="bg-red-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
            <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"></svg>
        </button>
    );
